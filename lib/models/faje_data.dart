...
Map homePagePosterMap = {
  ...
  "writer": "ملیکا عزیزی",
  "date": "یک روز پیش",
  "title": "دوازده قدبم برنامه نویسی یک دوره",
  "like": "251",
};

// blog fake data

List<HashTags> tagsList = [
  HashTags(title: "برنامه نویسی"),
  HashTags(title: "فلاتر"),
  HashTags(title: "دارت"),
  HashTags(title: "تکنولوژی"),
...
// create fack data for hotest podcasts
List<HotestPodcasts> podcastsList = [
  HotestPodcasts(
    id: 1,
    podcastTitle: "تکنولوژی چیه",
    creator: "علیرضا فرمانی",
    podcastImage: Assets.images.podcast1.path,
  ),
  HotestPodcasts(
    id: 2,
    podcastTitle: "برنامه نویسی چیه؟",
    creator: "ساسان صفری",
    podcastImage: Assets.images.podcast2.path,
  ),
  HotestPodcasts(
    id: 3,
    podcastTitle: "بهترین زبان های برنامه نویسی برای شروع",
    creator: "سارا تهرانی",
    podcastImage: Assets.images.podcast3.path,
  ),
  HotestPodcasts(
    id: 4,
    podcastTitle: "جایگاه هوش مصنوعی در برنامه نویسی",
    creator: "رضا زارع",
    podcastImage: Assets.images.podcast4.path,
  ),
  HotestPodcasts(
    id: 5,
    podcastTitle: "طراحی وب و چالش های اون",
    creator: "علیرضا فرمانی",
    podcastImage: Assets.images.podcast5.path,
  ),
];
